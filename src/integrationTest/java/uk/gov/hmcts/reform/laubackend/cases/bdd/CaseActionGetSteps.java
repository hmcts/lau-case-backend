...
public class CaseActionGetSteps extends AbstractSteps {
    ...
    public void retrieveWithEndTimestamp(final String path, final String endTimestamp) {
        final Response response = restHelper.getResponse(baseUrl() + path, Map.of("endTimestamp", endTimestamp));
        caseActionPostResponseBody = response.getBody().asString();
    }

    @And("And I GET {string} using startTimestamp {string} endTimestamp {string} query param")
    public void retrieveWithStartTime(final String path,
                                      final String startTimestamp,
                                      final String endTimestamp) {
        final Response response = restHelper.getResponse(baseUrl() + path, Map.of(START_TIME_PARAMETER,
                startTimestamp, END_TIME_PARAMETER, endTimestamp));
        caseActionPostResponseBody = response.getBody().asString();
    }

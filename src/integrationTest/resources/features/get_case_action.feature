Feature: The application's GET caseAction endpoint
  ...
  Scenario: The backend is able to process using startTimestamp endTimestamp query caseAction GET requests
    Given LAU backend application is healthy
    ...
    And And I GET "/audit/caseAction" using startTimestamp "2022-08-22T22:20:05" endTimestamp "2022-08-25T22:20:05" query param

  ...
  CREATE TABLE case_action_audit (
   ...
   case_action VARCHAR(16) CHECK (case_action in ('VIEW','UPDATE','CREATE')) NOT NULL,
  ...
  GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE case_action_audit, case_search_audit, case_search_audit_cases, flyway_schema_history TO lauuser;

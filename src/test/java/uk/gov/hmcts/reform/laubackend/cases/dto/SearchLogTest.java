...
class SearchLogTest {
    ...
    void shouldRemoveDashesAndUnderscoresFromCaseRefList() {
        ...
        final SearchLog searchLog = new SearchLog(null, new ArrayList<>(asList(caseRefWithDash,
    ...
    void shouldTrimCaseRefList() {
        ...
        final SearchLog searchLog = new SearchLog(null, new ArrayList<>(asList(caseRef1, caseRef2)), null);

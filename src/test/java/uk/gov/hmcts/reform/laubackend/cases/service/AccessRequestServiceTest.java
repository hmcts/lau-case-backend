...
class AccessRequestServiceTest {
    ...
    void shouldRetrieveRecords() {
        ...
        when(accessRequestFindRepository.findAccessRequest(accessRequest,null, pageRequest)).thenReturn(pagedResults);
        ...
        verify(accessRequestFindRepository, times(1)).findAccessRequest(accessRequest,null, pageRequest);
